...
# Create a list of image file paths using glob
...
frames[0].save('dcgan.gif', save_all=True, append_images=frames[1:], duration=200, loop=0)

# Display the GIF (Note: This may not work in all environments)
